...
const Newsletter: React.FC<NewsletterSignupProps> = () => {
  ...
  return (
    <div className="bg-red-600 py-6 px-4 md:px-8 rounded-md shadow-md flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      >
        ...
        <button
          type="submit"
          className="border border-white text-white font-semibold py-2 px-4 rounded-md w-full sm:w-auto transition duration-300"
        >
          Subscribe Now
        </button>
      </form>
